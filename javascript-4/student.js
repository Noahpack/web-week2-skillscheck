...
// CODE HERE
let faveColors = ["red", "black", "purple"]
//////////////////Step 2////////////////////
...
let me = {
    firstName: "Noah",
    superHeroName: "Captain Code",
    homeTown: "Gotham",
    superPowers: ["Super Coding", " Hacking 100", " Ultimate Data"],
...
// CODE HERE
function setColor(faveColors){
faveColors.splice(3, 10)
for(let i = 0; i < faveColors.length; i++){
    if(faveColors[i] === "blue"){
        return "#4D4DFF"
         }
    }
    background("red", "black", "purple")
}
//////////////////Step 5////////////////////
...
function redactInfo(obj){
    for(let i = 0; obj.length; i++){
        if(obj[i]=== [' Super Coding', ' Hacking 100', ' Ultimate Data']){
        return 'redacted'
        }
    }
